...
@section('content')
<form method="POST" action="{{ route('send-notification') }}"  class="col-lg-12 col-12 col-md-8" style="margin-top:8rem;" enctype="multipart/form-data">
    ...
    <i class="fa-solid fa-lock fa-lg mt-5"></i>
        ...
        <div class="input-group mb-3 col-lg-8 mx-auto mt-3 ">
            ...
            <input type="email" class="form-control" name="email" placeholder="Enter your email" aria-label="Username" aria-describedby="basic-addon1">
        </div>
        <small class="text-danger small mx-auto">{{ $errors->first('email') }}</small><br>
