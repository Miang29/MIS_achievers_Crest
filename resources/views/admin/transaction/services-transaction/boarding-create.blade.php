...
@section('title', 'Create Boarding Transaction')
			...
			<div class="col-12 col-md-12 col-lg-12 mx-auto">
				...
				<div class="card-body" >
					<div class="row "id="form-area-boarding"  >
				 		<div class="col-12 col-md-12 col-lg-5  mr-4 ml-5 my-2 border border-secondary boarding position-relative" id="orig-boarding" >
				 		{{-- PET INFORMATION --}}
...
<script type="text/javascript">
	$(document).ready(() => {
		...
		$(document).on('click', '#addboarding', (e) => {
			let obj = $(e.currentTarget);
			let form = $("#orig-boarding");
			let container = $("#form-area-boarding");
