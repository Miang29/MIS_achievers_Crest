            ...
            <div class ="row">
                ...
                <div class="col-lg-6 col-md-4 col-6 mx-auto">
                    <div class="input-group mb-3">
                      ...
                      <input type="text" class="form-control bg-white" readonly value="{{ $boardTran->reference_no}}" aria-describedby="basic-addon1">
                    </div>
                </div>
                ...
                <div class="col-lg-6 col-md-4 col-6 mx-auto">
                    <div class="input-group mb-3">
                      ...
                      <input type="text" class="form-control bg-white" readonly value="{{ $boardTran->mode_of_payment}}" aria-describedby="basic-addon1">
                    </div>
                </div>
            </div>
             ...
             <div class="card-body">
	            <div class="row mb-3">
	               @foreach($boardTran->boarding as $bt)
		                      	...
		                      	<div class="col-lg-12 col-md-12 col-12">
		                      		...
		                      		<div class="input-group mb-3 mt-3">
	                                    <div class="input-group-prepend">
                                        	...
                                        	<input type="text" class="form-control bg-white" readonly value="{{ $bt->variations->variation_name }}"  aria-describedby="basic-addon1">
                                	</div>
									...
									<div class="input-group mb-2">
	                                    <div class="input-group-prepend">
	                                        ...
	                                        <input type="text" class="form-control bg-white" readonly value="₱{{ $bt->price }}.00"  aria-describedby="basic-addon1">
                               		</div>
                                	...
                                	<div class="input-group mb-2">
	                                    <div class="input-group-prepend">
	                                        ...
	                                        <input type="text" class="form-control bg-white" readonly value="{{ $bt->petsInformations->pet_name }}"  aria-describedby="basic-addon1">
                                	</div>
		                      	</div>
		                  	</div>
	              	  	</div>
