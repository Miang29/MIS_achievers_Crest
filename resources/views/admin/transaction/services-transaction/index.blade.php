...
<div class="container-fluid px-2 px-lg-6 py-2 h-100 my-3">
    <div class="row">
        ...
        <div class="col-12 col-md-6 col-lg my-2 text-center text-md-left text-lg-right">
            <a href="{{route('services.create')}}" class="btn btn-info bg-1"><i class="fas fa-plus-circle mr-2"></i>Add transaction</a>
        </div>
                        ...
                        <td>
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdown">
                                    <a href="{{route('services.view')}}" class="dropdown-item"><i class="fa-solid fa-eye mr-2"></i>View</a>
