...
<h3 class="mt-3"><a href="{{route ('transaction.products-order') }}" class="text-decoration-none  text-1"><i class="fas fa-chevron-left mr-2"></i>Product Order List</a></h3>
    ...
    <div class="row" id="form-area">
        <div class="col-lg-8 col-md-8 col-12 mx-auto my-5 ">
            ...
            <div class="card card-body position-relative shadow p-3 mb-5 border-primary w-lg-100 w-100 w-md-100">
                ...
                {{-- REFERENCE NO --}}
                <div class="mt-5 border-secondary border-bottom w-lg-50 w-md-100 w-100 mx-auto">
                ...
                {{-- MODE OF PAYMENT --}}
                <div class="mt-3 border-secondary border-bottom w-lg-50 w-md-100 w-100 mx-auto">
