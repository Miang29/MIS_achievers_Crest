...
<div class="container-fluid px-2 px-lg-6 py-2 h-100 my-3">
	...
	<div class="card mx-auto mt-4">
		...
		<div class="position-absolute border rounded input m-0" style="top: -1rem; right: -1rem;">
			<a href="{{ route("pet-information.pet.add", [$id]) }}" class="btn btn-md bg-white border-light"><i class="fa-solid fa-plus text-black"></i></a>
	...
	<div class="modal-dialog modal-dialog-centered modal-lg" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title">{{ $p->pet_name }} ({{ $p->breed }})</h5>
