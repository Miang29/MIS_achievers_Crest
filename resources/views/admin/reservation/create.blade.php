	...
	<form class="form">
		...
		<div class="row">
			<div class="col-12 my-3 d-flex flex-row">
				<button class="btn btn-outline-info ml-auto mr-1"><a href="#"></a>Save</button>
				<button class="btn btn-outline-danger ml-1 mr-auto"><a href="#"></a>Cancel</button>
			</div>
		</div>
	</form>
</div>
...
<script type="text/javascript">
	const addForm = (listener, targetR) => {
		...
		<div class="col-6 my-2 mx-auto">
			<div class="card mx-auto">
				<h5 class="card-header text-center position-relative">Pet Registration<span class="position-absolute" style="top: 0.125rem; right: 0.5rem; cursor: pointer;" onclick="$(this).parent().parent().parent().remove();"><i class="fas fa-multiply"></i></span></h5>
