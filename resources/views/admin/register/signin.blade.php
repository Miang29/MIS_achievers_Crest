                ...
                <div class="card w-sm-75 w-md-50 w-lg-25 m-auto">
                    ...
                    {{--USERNAME--}}
                        <div class="form-group">
                                ...
                                <input type="username" placeholder="Username" class="form-control bg-white border-secondary" id="Inputusername">
                            </div>
                        </div>
                    ...
                    {{--PASSWORD--}}
                        ...
                        <p class="text text-center"> Don't have account? <a class="signup-link"
