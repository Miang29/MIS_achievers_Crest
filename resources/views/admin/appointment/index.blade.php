            ...
            <table class="table table-striped ">
                ...
                <tbody>
                    <tr>
                        <td>Tukmol</td>
                        <td>Multo</td>
                        <td>{{ \Carbon\Carbon::now()->timezone('Asia/Manila')->format('M d, Y g:i A') }}</td>
                        ...
                        <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdown">
                                    <a href="{{route ('appointments.show', [1])}}" class="dropdown-item"><i class="fa-solid fa-eye mr-2"></i>View Appointment</a>
                                    <a href="{{route ('appointments.edit', [1])}}" class="dropdown-item"><i class="fa-solid fa-pen-to-square mr-2"></i>Edit Appointment</a>
