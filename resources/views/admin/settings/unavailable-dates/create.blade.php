...
@section('content')
<form method="POST" action="{{ route('settings.mass.update')}}" class="container-fluid m-0"  enctype="multipart/form-data">
	...
	<div class="col-12 col-lg-12 col-md-12 my-2 mx-auto">
		<div class="card mx-auto">
			<h3 class="card-header text-white bg-1 text-center">Update Appointment Status</h3>
			...
			<div class="card-body">
				...
				<div class="col-lg-12 col-12 col-md-12">
					<div class="row" id="statusContainer">
						<div class="card col-lg-5 mt-3 py-4 position-relative mr-3 ml-5 mb-2" id="statusOg">
							{{--- UNAVAILABLE DATE --}}
					 		<div class="form-group">
								<div class="input-group">
									<div class="input-group-prepend">
				...
				<div class="form-group col-lg-12 col-md-12 col-12 mx-auto">
					<button class="card mx-auto w-100 h-100 d-flex" type="button" style="border-style: dashed; border-width: .25rem;" id="addStatus">
						<span class="m-auto font-weight-bold text-1"><i class="fa-solid fa-circle-plus mr-2"></i>Add</span>
					</button>
				</div>
			</div>
		</div>
