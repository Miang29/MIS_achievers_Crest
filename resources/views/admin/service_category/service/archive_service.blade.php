...
@section('title', 'Archive Services')
    ...
    <div class="overflow-x-auto h-100 card">
        <div class=" card-body h-100 px-0 pt-0">
            <table class="table table-striped text-center" id="table-content">
                <thead>
                    <tr>
                        <th scope="col" class="hr-thick text-1 text-center">Services Name</th>
                ...
                <tbody>
                   @forelse ($services as $s)
                    <tr>
                        ...
                        <td class="text-center">{{ $s->deleted_at}}</td>
                        <td class="text-center">
                            <a href="{{ route('service_category.restore',[$s->id])}}" type="button" class="btn btn-success btn-sm">Restore</a>
                        </td>
                    </tr>
                    @empty
                    <tr>
