...
<div class="container-fluid m-0 ">
	<h3 class="text-center text-lg-left  text-sm-left mx-0 mx-lg-5 my-3">
		<a href="{{route('services.show.view', [1]) }}" class="text-decoration-none text-1"><i class="fas fa-chevron-left mr-2"></i>Variation List</a>
	</h3>
		...
		<div class="col-8 col-md-8 mx-auto my-5 ">
			...
			<div class="card card-body position-relative shadow p-3 mb-5 border-primary w-lg-100 w-xs-100 w-md-100">
				<div class="position-absolute border border-secondary bg-1 text-white text-center d-flex w-75 w-lg-50 text-wrap" style="top: -1.8rem; left:1.5rem; min-height:4rem; max-height: 4rem; border-radius:0.5rem;">
					{{-- CATEGORY NAME --}}
					<button class="btn" data-toggle="tooltip" data-placement="left" title="{{ $services['category_name']}}"></button>
					<span class="h2 m-auto text-truncate" >{{ $services["category_name"]}}</span>
				</div>
				...
				<div>
					<div class=" mt-5 border-secondary border-bottom w-lg-50 mx-auto">
						...
						<span class="h5 m-auto text-wrap text-1">{{ $services["service_name"]}}</span>
					</div>
					...
					<div class="mt-3 border-secondary border-bottom w-lg-50 mx-auto">
						...
						<span class="h5 m-auto text-wrap text-1">{{ $services["variation_name"]}}</span>
					</div>
					...
					<div class="mt-3 border-secondary border-bottom w-lg-50 mx-auto">
						...
						<span class="h5 m-auto text-wrap text-1">{{ $services["remarks"]}}</span>
					</div>
				</div>
			</div>
		</div>
