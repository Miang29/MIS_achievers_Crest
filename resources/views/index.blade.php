...
<div class="about mt-5 h-100 bg-custom min-vh-100" id="about">
    ...
    <div class="row w-100 mb-2 " >
        ...
        <div class=" col-12 col-md-6  mt-5 d-flex text-center h-100"style="border-left: solid white;">
...
<div class="contact bg-white min-vh-100" id="contact">
    ...
    {{-- Content --}}
    <div class="col-12 w-75 mt-5 my-5 mx-auto w-lg-75 w-md-100 ">
        <div class="card my-3 mx-auto w-100  border border-secondary">
            ...
            <div class="card-body d-flex  border border-secondary">
                <div class="form-group mx-auto w-75 w-xs-100">
                    <div class="col-12 ">
