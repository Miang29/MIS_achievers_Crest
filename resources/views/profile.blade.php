...
<div class="container-fluid m-0">
    ...
    <div class="row" id="form-area">
        <div class="col-12 col-lg-6 col-md-8 mx-auto my-5">


            <div class="card card-body position-relative shadow p-3 mb-5 border-primary w-lg-100 w-xs-100 w-md-100 h-100">
                ...
                <div>
                    ...
                    <div class="mt-5 border-secondary border-bottom w-lg-75 mx-auto">
                        <button class="btn mr-5" data-toggle="tooltip" data-placement="left" title="Email"><i class="fa-solid fa-envelope mr-2"></i>Email</button>
                    ...
                    <div class="mt-3 border-secondary border-bottom w-lg-75 mx-auto">
                        <button class="btn mr-2" data-toggle="tooltip" data-placement="left" name="user_type" title="User Type"><i class="fa-solid fa-users mr-2"></i>User Type</button>
                    ...
                    {{-- USERNAME --}}
                    <div class="mt-3 border-secondary border-bottom w-lg-75 mx-auto">
                        <button class="btn mr-2" data-toggle="tooltip" data-placement="left" title="User Name"><i class="fa-solid fa-user mr-2"></i>Username</button>
