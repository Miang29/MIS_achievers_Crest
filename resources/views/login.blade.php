...
<html lang="en-US">
	...
	<body>
		...
		<main class="d-flex flex-row min-vh-100 js-only" id="content">
			<div class="col-12 col-lg-4 bg-white d-none d-lg-flex flex-column">
				<div class="my-auto d-flex flex-column">
					<img src="{{ asset('uploads/settings/banner.png') }}" class="img img-fluid mx-auto my-5 w-75" alt="Nano machines son">
					<h2 class="w-75 mt-auto mx-auto text-custom-1 my-5 text-center">VETERINARY CLINIC</h2>
				</div>
			</div>

			<div class="col-12 col-lg-8 bg-custom-1 d-flex flex-column">
				<div class="my-auto">
					...
					<form action="{{ route('authenticate') }}" method="POST" class="form w-75 w-lg-50 mb-auto mx-auto">
						...
						<div class="form-group text-center">
							<button type="submit" class="btn btn-outline-light w-100 font-weight-bold">LOGIN</button>
						</div>
					</form>
					{{-- LOGIN FORM END --}}
				</div>
